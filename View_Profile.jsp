<%-- 
    ...
    Created on : 12 Nov, 2021, 10:36:34 AM
    Author     : Genius
--%>
   ...
   <div class="profile">
   	        ...
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
					 ...
					 <li data-thumb="profile/<%=rs.getString("code")%>.jpg">
                                             <img src="profile/<%=rs.getString("code")%>.jpg" class="img-responsive">						</li> 
						
					 </ul>
				  </div>
			</div>
			<div class="col-sm-8 row_1" id ="record1">
				        	...
				        	<tbody>
				        		<tr class="opened_1">
									<td class="day_label">First Name :</td>
                                                                        <td class="day_value" class="table-responsive"><% out.print(rs.getString("fname")); %>   </td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Last Name :</td>
									<td class="day_value" class="table-responsive"><% out.print(rs.getString("lname")); %>  </td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Email :</td>
									<td class="day_value"class="table-responsive"><% out.print(rs.getString("email")); %>  </td>
								</tr>
							    
							    <tr class="opened">
									<td class="day_label">Gender :</td>
									<td class="day_value"class="table-responsive"><% out.print(rs.getString("gender")); %>  </td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Caste :</td>
									<td class="day_value"class="table-responsive"><% out.print(rs.getString("caste")); %>  </td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Religion :</td>
									<td class="day_value" class="table-responsive"><% out.print(rs.getString("religion")); %>  </td>
								</tr>
     ...
     <div class="col-md-4 profile_right">
     	<div class="newsletter">
		   <form>
			  <input type="text" name="ne" size="100%" required="" placeholder="Enter Name for Search Record.... ......................" id="search">

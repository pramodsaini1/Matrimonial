...
<%
  if(request.getParameter("code")==null){
      response.sendRedirect("register.jsp?image_error=1");
  }
  else{
...
<form method="post" ACTION="FileUploadProcess.jsp?code=<%out.print(code);%>" name="uploadForm" ENCTYPE='multipart/form-data'>

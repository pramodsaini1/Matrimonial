<%-- 
    Document   : profile1
    Created on : 15 Nov, 2021, 12:55:19 PM
    Author     : Genius
--%>
...
<%
   ...
   try{
       ...
       ResultSet rs = st.executeQuery("select * from ecb where code='"+code+"'");
       if(rs.next()){
           %>
...
<div class="grid_3">
  <div class="container">
   ...
   <div class="profile">
   	 <div class="col-md-8 profile_left" id="rec1">
   	 	<h2>Profile Id : <%=rs.getString("code")%></h2>
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
					 <ul class="slides">
						<li data-thumb="profile/<%=rs.getString("code")%>.jpg">
					     <img src="profile/<%=rs.getString("code")%>.jpg" class="img-responsive" style='height:300px' />
						</li>
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
									...
									<td class="day_value"><% out.print(rs.getString("fname")); %> </td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Last Name :</td>
									<td class="day_value"><% out.print(rs.getString("lname")); %></td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Gender :</td>
									<td class="day_value"><% out.print(rs.getString("gender")); %></td>
								</tr>
								<tr class="opened_1">
									<td class="day_label">DOB :</td>
									<td class="day_value"><% out.print(rs.getString("dob")); %> </td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Caste :</td>
									<td class="day_value"><% out.print(rs.getString("caste")); %></td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Religion :</td>
									<td class="day_value"><% out.print(rs.getString("religion")); %></td>
								</tr>
								
								<tr class="opened_1">
									<td class="day_label">Country :</td>
									<td class="day_value"><% out.print(rs.getString("country")); %></td>
								</tr>
								<tr class="opened_1">
									<td class="day_label">State :</td>
									<td class="day_value"><% out.print(rs.getString("state")); %></td>
								</tr>
				    </tbody>
				</table>
				<form method="post" action="msg.jsp?id=<% out.print(rs.getString("code")); %> ">
				     <label>Message</label><br>
				     <input type="text" text area rows=4 class="form-control" name="msg"></textarea><br><br>
				     <input type="submit" class="btn btn-danger" value="Submit Message">
			    </form>
			</div>
			<div class="clearfix"> </div>
		</div>
     ...
     <div class="col-md-4 profile_right">
     	<div class="newsletter">
		   <form>
			  <input type="text" name="ne" size="30" required="" placeholder="Enter Search Record..... :" id="rec2">
